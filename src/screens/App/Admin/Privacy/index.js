    ...
    <Box style={styles.container}>
      ...
      <ScrollView>
        <View style={styles.content}>
          <Text>
            Recapp LLC built the Recapp app as a Freemium app. This SERVICE is
            provided by Recapp LLC at no cost and is intended for use as is.
          </Text>
          ...
          <Text style={styles.text}>
            ...
            our Terms and Conditions, which are accessible at Recapp unless
          ...
          <Text style={{...styles.text, fontWeight: '600'}}>Log Data</Text>
          <Text style={styles.text}>
          ...
          <Text style={{...styles.text, fontWeight: '600'}}>Cookies</Text>
          <Text style={styles.text}>
          ...
          <Text style={{...styles.text, fontWeight: '600'}}>Security</Text>
          <Text style={styles.text}>
          ...
          <Text style={styles.text}>
            ...
            do not hesitate to contact us at Support@Re-capp.com.
          </Text>
        </View>
      </ScrollView>
    </Box>
