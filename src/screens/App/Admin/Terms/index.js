      ...
      <ScrollView>
        <View style={styles.content}>
          <Text>
            ...
            related to it, still belong to Recapp LLC.
          </Text>
          <Text style={styles.text}>
            Recapp LLC is committed to ensuring that the app is as useful and
            ...
            The Recapp app stores and processes personal data that you have
            ...
            phone’s security features and it could mean that the Recapp app
            won’t work properly or at all.
          </Text>
          <Text style={styles.text}>
            You should be aware that there are certain things that Recapp LLC
            ...
            but Recapp LLC cannot take responsibility for the app not working at
          ...
          <Text style={styles.text}>
            Along the same lines, Recapp LLC cannot always take responsibility
            ...
            it on to avail the Service, Recapp LLC cannot accept responsibility.
          </Text>
          <Text style={styles.text}>
            With respect to Recapp LLC’s responsibility for your use of the app,
            ...
            that we can make it available to you. Recapp LLC accepts no
          ...
          <Text style={styles.text}>
            ...
            the updates if you want to keep using the app. Recapp LLC does not
          ...
          <Text style={{...styles.text, fontWeight: '600'}}>Contact Us</Text>
          <Text style={styles.text}>
            If you have any questions or suggestions about our Terms and
            Conditions, do not hesitate to contact us at Support@Re-capp.com.
          </Text>
        </View>
      </ScrollView>
    </Box>
